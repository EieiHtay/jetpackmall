...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo e(asset('logo/favicon.jpg')); ?>" type="image/gif" sizes="16x16">

    <!-- iconFont -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('icon/icofont/icofont.min.css')); ?>">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('logo/logo_transparent.png')); ?>"  alt="">
            </a>
        </div>
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    <a href="<?php echo e(route('cart')); ?>"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti"></span>
                    </a>
                </li>
            </ul>
        ...
        <div class="humberger__menu__widget">
            ...
            <?php else: ?>
                <div class="header__top__right__language">
                    <img src="<?php echo e(asset(Auth::user()->profile)); ?>" alt="" class="userprofile">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a href="<?php echo e(route('promotion')); ?>"> Promotion </a></li>
                <li><a href="#"> Merchants </a>
                    <ul class="header__menu__dropdown">
                        <?php $__currentLoopData = $data[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(route('brand',$brand->id)); ?>">
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>
                    <img src="<?php echo e(asset('logo/download_mb.png')); ?>">
                </li>
            </ul>
        </div>
    </div>
    ...
    <!-- Header Section Begin => Laptop View-->
    <header class="header">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('logo/logo_transparent.png')); ?>" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('promotion')); ?>"> Promotion </a>
                            </li>
                            <li><a href="#"> Merchants </a>
                                <ul class="header__menu__dropdown">
                                    <?php $__currentLoopData = $data[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li>
                                <a href="<?php echo e(route('cart')); ?>"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti"></span></a>
                            </li>
                        </ul>
                        <a href="<?php echo e(route('cart')); ?>">
    ...
    <!-- Hero Section Begin /Reguest->hero-normal => data hidden in subcategory-->
    <section class="hero <?php echo e(Request::segment(1)==''?'':'hero-normal'); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <?php $__currentLoopData = $data[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('subcategory',$subcategory->id)); ?>">
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                     ...
                     <?php if(Request::segment(1) == '' || Request::segment(1) == 'index'): ?>

                    <div class="hero__item set-bg bg-light">
                        <div class="row">
                            <div class="col-8">
                                <h2 class="my-5"> <?php echo e($data[3][0]->name); ?> </h2>
                                <a href="<?php echo e(route('brand',$data[3][0]->id)); ?>" class="primary-btn">SHOP NOW</a>
                                
                            </div>
                            <div class="col-4">
                                <img src="<?php echo e(asset($data[3][0]->logo)); ?>" class="img-fluid">
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('frontend/img/logo.png')); ?>" alt=""></a>
                        </div>
                        <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img src="<?php echo e(asset('frontend/img/payment-item.png')); ?>" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if(Auth::check()): ?>
        <script>
            var deliveryprice = "<?php echo e(Auth::user()->township->price); ?>";
        </script>
    <?php else: ?>
    ...
    <script src="<?php echo e(asset('shoppingcart.js')); ?>"></script>


</body>

</html><?php /**PATH /opt/lampp/htdocs/jetpackmall/resources/views/components/frontend.blade.php ENDPATH**/ ?>