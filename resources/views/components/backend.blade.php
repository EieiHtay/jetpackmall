...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset(Auth::user()->profile)}}" alt="User Image" width="70px" height="70px">
                <div>
        ...
        {{-- want to work summernote only item --}}
