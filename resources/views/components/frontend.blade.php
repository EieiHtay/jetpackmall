...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="{{route('index')}}">
                <img src="{{asset('logo/logo_transparent.png')}}"  alt="">
            </a>
        </div>
                ...
                <li><a href="#"> Merchants </a>
                    <ul class="header__menu__dropdown">
                        @foreach($data[0] as $brand)
                            <li><a href="{{route('brand',$brand->id)}}">
                                {{$brand->name}}
                            </a></li>
                        @endforeach
                    </ul>
            ...
            <div class="row">
                    ...
                    <div class="hero__categories">
                        ...
                        <ul>
                            @foreach($data[1] as $subcategory)
                                <li><a href="{{route('subcategory',$subcategory->id)}}">
                                    {{$subcategory->name}}
                                </a></li>
                            @endforeach
                        </ul>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg bg-light">
                        <div class="row">
                            <div class="col-8">
                                <h2 class="my-5"> {{ $data[3][0]->name }} </h2>
                                <a href="{{ route('brand',$data[3][0]->id) }}" class="primary-btn">SHOP NOW</a>
                                
                            </div>
                            <div class="col-4">
                                <img src="{{ asset($data[3][0]->logo) }}" class="img-fluid">
                            </div>
