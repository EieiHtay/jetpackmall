							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#newphoto" role="tab" aria-controls="profile" aria-selected="false">NewPhoto</a>
                                        </li>

                                    </ul>
	                                <div class="tab-content" id="myTabContent">
	                                    <div class="tab-pane fade show active" id="oldphoto" role="tabpanel" aria-labelledby="home-tab">
	                                        <img src="{{asset($photo)}}" width="100" height="100">
	                                    
	                                    </div>
	                                    <div class="tab-pane fade" id="newphoto" role="tabpanel" aria-labelledby="profile-tab">
